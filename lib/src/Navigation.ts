...
export class Navigation {
   ...
   */
  public registerComponent(componentName: string, getComponentClassFunc: ComponentProvider, reduxStore, reduxProvider, reduxOptions): React.ComponentType<any> {
    return this.componentRegistry.registerComponent(componentName, getComponentClassFunc, reduxStore, reduxProvider, reduxOptions);
  }
